        ...
        <form onSubmit={(e) => handleSubmit(e, false)} className="p-6 sm:p-8 overflow-y-auto space-y-6">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 pt-4 border-t border-slate-200">
            <button
              type="button"
              onClick={onClose}
              className="w-full sm:w-auto px-5 py-3 rounded-2xl border border-slate-200 text-slate-700 hover:bg-slate-100 font-extrabold text-xs transition-all cursor-pointer"
            >
              Close
            </button>
            ...
            <div className="w-full sm:w-auto flex-1 flex items-center gap-2">
              <button
                ...
                disabled={isLoading}
                className="flex-1 py-3 rounded-2xl bg-slate-900 hover:bg-slate-800 text-white font-extrabold text-xs transition-all flex items-center justify-center gap-1.5 cursor-pointer shadow-sm"
              >
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="flex-1 py-3 rounded-2xl bg-indigo-600 hover:bg-indigo-500 text-white font-black text-xs transition-all shadow-lg shadow-indigo-600/25 flex items-center justify-center gap-1.5 cursor-pointer"
              >
