...
export const LoginVideoBackground: React.FC = () => {
  ...
  return (
    <div
      ...
      className="absolute inset-0 w-full h-full overflow-hidden select-none pointer-events-none rounded-t-[32px] md:rounded-none bg-gradient-to-br from-[#7C5CFC] via-[#6846EC] to-[#4F2FD4]"
    >
      ...
      {!videoError && (
        <video
          ...
          className="absolute inset-0 w-full h-full min-w-full min-h-full object-cover object-top z-0 transition-opacity duration-700 transform-gpu pointer-events-none select-none"
        >
