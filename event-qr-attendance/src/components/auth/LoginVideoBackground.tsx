...
export const LoginVideoBackground: React.FC = () => {
  ...
  return (
    <div className="absolute inset-0 w-full h-full overflow-hidden select-none rounded-t-[32px] md:rounded-l-[32px] md:rounded-tr-none bg-gradient-to-br from-[#7C5CFC] via-[#6846EC] to-[#4F2FD4]">
      ...
      {!videoError && (
        <video
          ...
          className="absolute inset-0 w-full h-full min-w-full min-h-full object-cover object-center scale-105 z-0 transition-opacity duration-700"
        >
      ...
      {/* Lighting Blend for High Readability of White Text */}
      <div className="absolute inset-0 bg-gradient-to-t from-indigo-950/60 via-purple-900/20 to-black/30 z-1 pointer-events-none" />
