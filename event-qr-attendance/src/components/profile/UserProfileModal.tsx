        ...
        <div className="p-6 overflow-y-auto flex-1 space-y-5">
          ...
          {activeTab === 'profile' ? (
            ...
            <form onSubmit={handleSaveProfileDetails} className="space-y-5">
              ...
              {/* Avatar Upload (Local Files Only) */}
              <div className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 border border-slate-200">
                ...
                <div className="flex-1 space-y-1.5">
                  ...
                  <p className="text-[10px] text-slate-400 font-medium">Select photo from device storage (Max 2MB)</p>
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 pl-10 text-xs text-slate-800 font-medium focus:outline-none focus:border-indigo-600 disabled:opacity-60 disabled:cursor-not-allowed"
                  />
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 pl-10 text-xs text-slate-800 font-mono font-medium focus:outline-none focus:border-indigo-600 disabled:opacity-60 disabled:cursor-not-allowed"
                  />
              ...
              {!isLocked && (
                ...
                >
                  {isLoading ? 'Saving Details...' : 'Save Profile Details (1-Time Lock)'}
                </button>
              )}
            </form>
          ) : (
