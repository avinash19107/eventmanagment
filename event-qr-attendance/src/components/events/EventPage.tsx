              ...
              {isAlreadyRegistered ? (
                ...
                <div className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200/90 shadow-xl space-y-6">
                  ...
                  <form onSubmit={handleRegisterSubmit} className="space-y-4">
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        <input
                          ...
                          disabled
                          value={attendeeName}
                          className="w-full bg-slate-100 border border-slate-200 rounded-xl px-4 py-2.5 pl-10 text-xs text-slate-600 font-bold cursor-not-allowed select-none"
                        />
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full bg-slate-100 border border-slate-200 rounded-xl px-4 py-2.5 pl-10 text-xs text-slate-600 uppercase font-bold cursor-not-allowed select-none"
                        />
                    ...
                    <div className="space-y-1.5">
                      <label className="text-xs font-extrabold text-slate-800">Mobile Number (Enter Phone Number) *</label>
                      <div className="relative">
                        <input
                          type="tel"
                          required
                          ...
                          className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 pl-10 text-xs text-slate-800 focus:outline-none focus:border-indigo-600 font-bold"
                        />
