...
export const UserEventPortal: React.FC<UserEventPortalProps> = ({
  ...
  useEffect(() => {
    const handlePopState = () => {
      ...
      } else if (isPlatformFeedbackModalOpen) {
  ...
  const loadEventsFromDB = async () => {
    ...
    try {
      ...
      localStorage.setItem('eqa_events', JSON.stringify(validEvents));
      ...
      rtdbRegs.forEach((r) => {
        ...
        if (validEventIds.has(r.eventId) && !str.includes('john') && !str.includes('hackathon')) {
      ...
      localStorage.setItem('eqa_registrations', JSON.stringify(validAllRegs));
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-indigo-600 selection:text-white pb-24 relative">
          ...
          <div className="relative z-10 w-80 max-w-[85vw] bg-white h-full shadow-2xl flex flex-col justify-between overflow-y-auto animate-in slide-in-from-left duration-300">
            <div>
              ...
              <div className="p-6 bg-gradient-to-br from-indigo-900 via-purple-950 to-slate-900 text-white space-y-3 relative overflow-hidden">
                ...
                <div className="flex items-center gap-3 pt-1">
                  ...
                  <div className="min-w-0">
                    <h3 className="text-base font-black tracking-tight text-white truncate">{currentUser.name || 'Attendee'}</h3>
              ...
              <div className="p-4 space-y-1.5">
                ...
                <div className="text-[10px] font-black uppercase tracking-wider text-slate-400 px-3 pt-3 pb-1">
                  Quick Actions
                </div>
                ...
                <button
                  onClick={() => {
                    setIsMobileMenuOpen(false);
                    setIsMyPassesDrawerOpen(true);
                  }}
                  className="w-full flex items-center justify-between p-3 rounded-2xl text-xs font-black text-slate-700 hover:bg-slate-50 transition-all cursor-pointer"
                >
                  <div className="flex items-center gap-3">
                ...
                {(currentUser.role === 'organizer' || currentUser.role === 'admin') && (
                  <button
                    ...
                    className="w-full flex items-center justify-between p-3 rounded-2xl text-xs font-black text-indigo-700 bg-indigo-50/80 hover:bg-indigo-100 border border-indigo-200/80 transition-all cursor-pointer"
                  >
                    <div className="flex items-center gap-3">
            ...
            <div className="p-4 border-t border-slate-100 bg-slate-50/50">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 p-3 rounded-2xl bg-white border border-slate-200 hover:bg-rose-50 hover:border-rose-200 text-rose-600 font-black text-xs shadow-xs transition-all cursor-pointer"
              >
      ...
      <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-xl border-b border-slate-200/90 px-3 sm:px-8 py-3 shadow-xs mb-2">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2.5 sm:gap-3 min-w-0">
            ...
            <button
              ...
              className="p-2 md:hidden rounded-2xl bg-indigo-50 hover:bg-indigo-100 border border-indigo-200/80 text-indigo-700 transition-all cursor-pointer flex items-center gap-1.5"
              title="Open Navigation Menu"
            >
              <Menu className="w-5 h-5 text-indigo-600" />
              <span className="text-xs font-black text-indigo-900 hidden xs:inline">Menu</span>
            </button>
            ...
            >
              <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-2xl bg-gradient-to-tr from-indigo-600 via-purple-600 to-pink-500 flex items-center justify-center shadow-md shadow-indigo-500/20 shrink-0">
                <QrCode className="w-5 h-5 text-white" />
              </div>
              <span className="text-base sm:text-xl font-black tracking-tight text-slate-900 truncate">ApexEvents</span>
            </div>
          </div>

          {/* Center Page Tabs Navigator for Laptops & Desktops */}
          ...
          <div className="flex items-center gap-1.5 sm:gap-2.5 shrink-0">
            ...
            {(currentUser.role === 'organizer' || currentUser.role === 'admin') && (
              <button
                ...
                className="hidden sm:flex items-center gap-1.5 px-3 sm:px-4 py-2 rounded-2xl bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white font-black text-xs shadow-md shadow-indigo-600/20 active:scale-95 transition-all cursor-pointer"
            ...
            >
              ...
              {myRegistrations.length > 0 && (
                <span className="px-1.5 py-0.2 rounded-full bg-indigo-600 text-white font-black text-[9px]">
                  {myRegistrations.length}
                </span>
              )}
            </button>
            ...
            <button
              ...
              className="relative group p-0.5 rounded-full hover:ring-2 hover:ring-indigo-500 transition-all cursor-pointer"
              title="Open My Profile & Settings"
            >
              <img
                src={currentUser.avatarUrl || 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=150'}
                alt={currentUser.name}
                className="w-8 h-8 sm:w-9 sm:h-9 rounded-full object-cover border border-slate-300 shadow-xs"
              />
            ...
            <button
              onClick={onSignOut}
              className="p-2 rounded-2xl bg-slate-100 hover:bg-rose-50 text-slate-600 hover:text-rose-600 active:scale-95 border border-slate-200 transition-all cursor-pointer"
              title="Sign Out"
            >
              <LogOut className="w-4 h-4" />
            </button>
      ...
      {/* ========================================================= */}
      {activePage === 'discover' && (
        <div className="space-y-8 sm:space-y-10 animate-fade-in pt-4 sm:pt-6">
          ...
          <section className="max-w-7xl mx-auto px-4 sm:px-8 space-y-6 sm:space-y-8 pt-2">
            <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4 border-b border-slate-200/90 pb-6">
              {/* Category Pills */}
              <div className="flex items-center gap-2 sm:gap-2.5 overflow-x-auto w-full md:w-auto pb-2 md:pb-0 scrollbar-none py-1">
                {categories.map((cat) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center gap-1.5 sm:gap-2 px-3.5 sm:px-4 py-2 sm:py-2.5 rounded-2xl text-xs font-bold whitespace-nowrap transition-all cursor-pointer active:scale-95 shrink-0 ${
                        isSelected
            ...
            {filteredEvents.length === 0 ? (
              <div className="p-12 sm:p-16 text-center rounded-3xl border border-slate-200 bg-white shadow-sm space-y-4 max-w-lg mx-auto my-14">
