  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-indigo-600 selection:text-white pb-24 relative">
      ...
      <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-xl border-b border-slate-200/90 px-4 sm:px-8 py-3 shadow-sm">
        ...
        <div className="flex md:hidden items-center justify-between gap-1 pt-2.5 mt-2 border-t border-slate-100">
          <button
            onClick={() => navigateToPage('discover')}
            className={`flex-1 flex items-center justify-center gap-1.5 py-2.5 rounded-xl font-black text-xs transition-all active:scale-95 ${
              activePage === 'discover'
                      ...
                      >
                        ...
                        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 w-full sm:w-auto shrink-0 pt-2 sm:pt-0 border-t sm:border-t-0 border-slate-200/70">
                          ...
                          <button
                            ...
                            className="w-full sm:w-auto px-4 py-2.5 rounded-xl bg-white hover:bg-indigo-600 hover:text-white active:scale-95 border border-slate-200 text-slate-800 font-bold text-xs transition-all cursor-pointer flex items-center justify-center gap-1.5 shadow-2xs"
                          >
