                ...
                {!isFree && (
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-4 py-2 text-xs font-bold text-slate-800 focus:bg-white focus:border-indigo-600 focus:outline-none transition-all"
                    />
                  </div>
                )}
              </div>
