...
import { User, UserRole, Event, Registration, AuditEvent } from '../../types';
...
export const AdminPortal: React.FC<AdminPortalProps> = ({
  ...
  // Navigation tabs
  const [activeTab, setActiveTab] = useState<'users' | 'events' | 'registrations' | 'audit'>('users');
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-purple-600 selection:text-white pb-24">
      ...
      <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-xl border-b border-slate-200 px-4 sm:px-8 py-3.5 shadow-sm">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          {/* Brand Logo & Master Badge */}
          <div className="flex items-center gap-3 w-full md:w-auto justify-between">
            <div className="flex items-center gap-2.5">
              <div className="w-10 h-10 rounded-2xl bg-gradient-to-tr from-purple-600 via-indigo-600 to-pink-600 flex items-center justify-center shadow-md shadow-purple-600/30 text-white font-black">
                <Shield className="w-5 h-5" />
              </div>
              <div>
                <div className="flex items-center gap-2">
                  <h1 className="text-xl font-black tracking-tight text-slate-900">ApexEvents</h1>
                  <span className="px-2 py-0.5 rounded-md bg-purple-100 text-purple-800 font-mono text-[10px] font-black uppercase tracking-wider border border-purple-200">
                    Admin Center
                  </span>
                </div>
                <p className="text-[10px] text-slate-500 font-mono">
                  Master Control • Realtime Database Oversight
                </p>
              </div>
            </div>
            ...
            <button
              ...
              disabled={isLoading}
              className="md:hidden p-2 rounded-xl bg-slate-100 text-slate-600 hover:bg-slate-200 cursor-pointer"
              title="Refresh Data"
            >
          ...
          <nav className="flex items-center gap-1.5 p-1 rounded-2xl bg-slate-100 border border-slate-200 w-full md:w-auto overflow-x-auto">
            <button
          ...
          <div className="flex items-center gap-2.5 w-full md:w-auto justify-end">
            ...
            {onSwitchPortalView && (
              <div className="hidden lg:flex items-center gap-1 bg-slate-100 p-1 rounded-xl border border-slate-200 text-xs font-bold text-slate-600">
                <span className="text-[10px] text-slate-400 uppercase font-mono px-1.5">View As:</span>
                <button
                  onClick={() => onSwitchPortalView('teacher')}
                  className="px-2.5 py-1 rounded-lg hover:bg-white hover:text-amber-700 hover:shadow-xs transition-all cursor-pointer"
                >
                  Teacher View
                </button>
                <button
                  onClick={() => onSwitchPortalView('organizer')}
                  className="px-2.5 py-1 rounded-lg hover:bg-white hover:text-indigo-600 hover:shadow-xs transition-all cursor-pointer"
                >
                  Organizer
                </button>
                <button
            ...
            <button
              onClick={loadSystemData}
              disabled={isLoading}
              className="p-2.5 rounded-xl bg-white hover:bg-slate-50 border border-slate-200 text-slate-600 hover:text-purple-600 shadow-sm transition-all cursor-pointer"
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-black text-xs shadow-md shadow-purple-600/20 transition-all cursor-pointer hover:scale-[1.02]"
            >
            ...
            <button
              onClick={onSignOut}
              title="Sign Out"
              className="p-2.5 rounded-xl bg-white hover:bg-rose-50 text-slate-400 hover:text-rose-600 border border-slate-200 shadow-sm transition-all cursor-pointer"
            >
          ...
          <div className="w-full max-w-lg bg-white rounded-3xl p-6 sm:p-8 shadow-2xl border border-slate-200 space-y-6">
            <div className="flex items-center justify-between border-b border-slate-100 pb-4">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h3 className="text-lg font-black text-slate-900">Create New Account</h3>
                  <p className="text-xs text-slate-500">Create a Teacher, Organizer, Attendee, or Admin in Firebase RTDB.</p>
                </div>
              </div>
              <button
            ...
            <form onSubmit={handleCreateUserSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="grid grid-cols-3 gap-2">
                  <button
                    ...
                    className={`py-2.5 px-3 rounded-xl border text-xs font-black flex flex-col items-center gap-1 transition-all cursor-pointer ${
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-xl border border-slate-200 bg-slate-50 text-xs font-semibold focus:bg-white focus:outline-none focus:ring-2 focus:ring-purple-500"
                />
              </div>
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-2.5 rounded-xl border border-slate-200 bg-slate-50 text-xs font-semibold focus:bg-white focus:outline-none focus:ring-2 focus:ring-purple-500 pr-10"
                  />
                  <button
                    type="button"
              ...
              <div className="flex items-center justify-end gap-3 pt-4 border-t border-slate-100">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-purple-600 to-indigo-600 text-white text-xs font-black shadow-md shadow-purple-600/30 hover:scale-[1.02] transition-all cursor-pointer"
                >
            ...
            <div className="flex items-center justify-between border-b border-slate-100 pb-4">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">Edit profile details, role, or reset password in Firebase RTDB.</p>
                </div>
              </div>
              <button
                ...
                <div className="grid grid-cols-4 gap-2">
                  {(['teacher', 'organizer', 'attendee', 'admin'] as UserRole[]).map((r) => (
                    <button
                      ...
                      className={`py-2 px-2 rounded-xl border text-[11px] font-black capitalize transition-all cursor-pointer ${
                        editForm.role === r
