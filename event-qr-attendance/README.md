...
| Role | Email ID / Login | Password | Access Capabilities |
| :--- | :--- | :--- | :--- |
| **🛡️ Admin** | `admin@apexevents.in` | `admin123` | Master control, user management, audit logs, event controls |
| **🎪 Organizer** | `organizer@apexevents.in` | `organizer123` | Host events, mobile QR gate scanner, check-in rosters |
| **🎓 Teacher** | `teacher@apexevents.in` | `teacher123` | View student attendance records, events participation analytics |
